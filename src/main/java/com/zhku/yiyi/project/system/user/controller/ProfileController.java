...
import com.zhku.yiyi.framework.web.service.DictService;
...
import com.zhku.yiyi.common.utils.file.FileUploadUtils;
...
public class ProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(User user, @RequestParam("avatarfile") MultipartFile file)
    {
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(YiyiConfig.getAvatarPath(), file);
