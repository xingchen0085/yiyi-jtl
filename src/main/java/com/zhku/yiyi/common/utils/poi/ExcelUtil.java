package com.zhku.yiyi.common.utils.poi;
...
import com.zhku.yiyi.framework.aspectj.lang.annotation.Excel;
...
public class ExcelUtil<T>
{
    ...
    {
        String downloadPath = YiyiConfig.getDownloadPath() + filename;
